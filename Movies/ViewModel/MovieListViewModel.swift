...
final class MovieListViewModel {
	...
	//				state = .empty
	//			} else {
	//				cache.writeToCache(response.results, category: selectedCategory.rawValue, page: currentPage, context: context)
	//				state = .success(response.results)
	//			}
	//		} catch {
	//			state = .failure(error)
	...
	//
	//	@MainActor
	//	func loadMoreMovies(context: ModelContext) async {
	//		guard currentPage < totalPages else { return }
	//		guard case .success(let current) = state else { return }
	//		guard monitor.isConnected else { return }
	//		let nextPage = currentPage + 1
	...
	//
	//	@MainActor
	//	func selectCategory(category: MovieCategory, context: ModelContext) async {
	//		guard category != selectedCategory else { return }
	//		selectedCategory = category
	//		currentPage = 1
	//		totalPages = 1
